...
public class ResultadoRadierActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    private void recibirDatos() {
        ...
        html = "<!DOCTYPE html>" +
                ...
                "<body>" +
                "<div >" +
                "<h3> RESULTADO RADIER</h3>"+
                "<h4> Cálculo para cubrir  "+ d1+ "  metros cúbicos (m³) H-20 </h4>"+
